...
jQuery(function($){
    var NFT_Trainer_Listing = function(){
        $(document).on('click', '.em_delete_trainer', function(e){
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if( result.isConfirmed ){
                    NFT_Trainer_Delete( $(this).closest('form') );
                }
            })
        })
    };

    var NFT_Trainer_Delete  = function( form ){

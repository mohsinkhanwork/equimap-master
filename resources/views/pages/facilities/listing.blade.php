...
<div class="d-flex flex-row justify-content-between text-center mb-5 gap-5">
    ...
    <div class="d-flex flex-grow-1 align-items-center position-relative">
        ...
        <input type="text" data-table-filter="search" class="form-control form-control-solid ps-15 py-5 border-0" placeholder="Search Facilities"/>
    </div>
    <!--end::Search-->
    ...
    @can('create facility')
        ...
        <div class="d-flex justify-content-end">
            <!--begin::Add facility-->
            <a href="{{ route('acp.facilities.create') }}" class="d-flex align-items-center btn btn-primary">
                <i class="fas fa-solid fa-plus fs-2"></i>
                <span class="d-none d-md-block">Add Facility</span>
            </a>
            <!--end::Add facility-->
        </div>
        <!--end::Toolbar-->

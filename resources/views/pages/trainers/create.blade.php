    ...
    <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
        ...
        <div class="card card-flush h-md-50 mb-5 mb-xl-10">
            ...
            <div class="card-body d-flex flex-column justify-content-end p-5">
                <!--begin::Form-->
                <form autocomplete="off" data-redirect-url="{{ route('acp.trainers.index') }}" id="em_create_trainer" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('acp.trainers.store') }}" method="post">
                    ...
                    <div class="form-floating mb-7">
                        <input type="text" id="em_trainer_name" name="name" class="form-control form-control-solid" placeholder="Trainer Name" />
                        <label for="em_trainer_name" class="required form-label">Trainer Name</label>
                    </div>
                    <div class="form-floating mb-7">
                        <input type="number" id="em_trainer_phone" name="phone" class="form-control form-control-solid" placeholder="Phone Number" />
                    ...
                    <button type="submit" id="submit_em_create_trainer" class="btn btn-primary">
                        @include('partials/general/_button-indicator', ['label' => '<i class="fs-2 fa-solid fa-plus"></i> Add Trainer' ])
                    </button>
                </form>
                <!--end::Form-->
            </div>

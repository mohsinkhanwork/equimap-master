...
<div class="d-flex flex-row justify-content-between text-center mb-5 gap-5">
    ...
    <div class="d-flex flex-grow-1 align-items-center position-relative">
        ...
        <input type="text" data-table-filter="search" class="form-control form-control-solid ps-15 py-5 border-0" placeholder="Search Horses"/>
    </div>
    <!--end::Search-->
    ...
    <div class="d-flex justify-content-end">
        <!--begin::Add horse-->
        <a href="{{ route('acp.horses.create') }}" class="d-flex align-items-center btn btn-primary lh-xl">
            <i class="fas fa-solid fa-plus fs-2"></i>
            <span class="d-none d-md-block">Add Horse</span>
        </a>
        <!--end::Add horse-->
    </div>
    <!--end::Toolbar-->

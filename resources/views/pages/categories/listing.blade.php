...
<div class="d-flex flex-row justify-content-between text-center mb-5 gap-5">
    ...
    <div class="d-flex flex-grow-1 align-items-center position-relative">
        ...
        <input type="text" data-table-filter="search" class="form-control form-control-solid ps-15 py-5 border-0" placeholder="Search Categories"/>
    </div>
    <!--end::Search-->
    ...
    @can('create category')
        ...
        <div class="d-flex justify-content-end">
            <!--begin::Add category-->
            <a href="{{ route('acp.categories.create') }}" class="d-flex align-items-center btn btn-primary">

...
<div class="d-flex flex-row justify-content-between text-center mb-5 gap-5">
    ...
    <div class="d-flex flex-grow-1 align-items-center position-relative">
        ...
        <input type="text" data-table-filter="search" class="form-control form-control-solid ps-15 py-5 border-0" placeholder="Search Providers"/>
    </div>
    <!--end::Search-->
    ...
    @can('create provider')
        ...
        <div class="d-flex justify-content-end">
            <!--begin::Add provider-->
            <a href="{{ route('acp.providers.create') }}" class="d-flex align-items-center btn btn-primary">
                <i class="fas fa-solid fa-plus fs-2"></i>
                <span class="d-none d-md-block">Add Provider</span>
            </a>
            <!--end::Add provider-->
        </div>
        <!--end::Toolbar-->
